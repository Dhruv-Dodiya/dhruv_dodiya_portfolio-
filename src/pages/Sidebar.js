    ...
    return(
        <div className={`w-screen h-screen ${isOpen ? "fixed" : "hidden"} top-0 left-0 bg-gray-800  z-20 text-white grid place-items-center`}>
            ...
            <div className="flex flex-col gap-4 text-[28px]">
                ...
                <a className='hover:text-[#ff4D41]' href="/About">About</a>
                {/* <a className='hover:text-[#ff4D41]' href="/Whatido">Portfolio</a> */}
                <a className='hover:text-[#ff4D41]' href="/Work">Blog</a>
                <a className='hover:text-[#ff4D41]' href="/Contect">Contact</a>
            </div>
        </div>
    )
}
